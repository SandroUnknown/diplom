...
> | `BROWSER_NAME`        | Опциональный                                    | Браузер, в котором будут выполняться тесты                     | https://flat-soft.ru  |
> | `BROWSER_VERSION`     | Опциональный                                    | Версия браузера, в которой будут выполняться тесты             | chrome                |
> | `BROWSER_SIZE`        | Опциональный                                    | Размер окна браузера, в котором будут выполняться тесты        | 125.0                 |
> | `API_URI`             | Обязательный для <br> `всех` тестов             | Адрес для отправки API-запросов                                | 1920x1080             |
> | `WEB_URL`             | Обязательный для <br> `всех` тестов             | Адрес тестируемого сайта                                       | https://flat-soft.ru  |
> | `TODOIST_EMAIL`       | Обязательный для <br> `всех` тестов             | Email (логин) для входа в аккаунт (на тестируемом сайте)       | chrome                |
> | `TODOIST_PASSWORD`    | Обязательный для <br> `всех` тестов             | Пароль от аккаунта (на тестируемом сайте)                      | 125.0                 |
> | `TODOIST_TOKEN`       | Обязательный для <br> `всех` тестов             | API-токен от аккаунта (на тестируемом сайте)                   | 1920x1080             |
> | `WEB_REMOTE_URL`      | Обязательный для <br> ` remote-web ` тестов     | Адрес удалённого сервера (для запуска web-тестов)              | chrome                |
> | `WEB_REMOTE_LOGIN`    | Обязательный для <br> ` remote-web ` тестов     | Логин от удалённого сервера (для запуска web-тестов)           | 125.0                 |
> | `WEB_REMOTE_PASSWORD` | Обязательный для <br> ` remote-web ` тестов     | Пароль от удалённого сервера (для запуска web-тестов)          | 1920x1080             |
> | `BROWSERSTACK_URL`    | Обязательный для <br> ` remote-android ` тестов | Адрес `browserstack` (для удалённого запуска android-тестов)   | chrome                |
> | `BROWSERSTACK_USER`   | Обязательный для <br> ` remote-android ` тестов | USER от `browserstack` (для удалённого запуска android-тестов) | 125.0                 |
> | `BROWSERSTACK_KEY`    | Обязательный для <br> ` remote-android ` тестов | KEY от `browserstack` (для удалённого запуска android-тестов)  | 1920x1080             |

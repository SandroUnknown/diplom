...
> | `TASK`                | Обязательный <br> (для `всех` тестов) | Имя задачи в Gradle</br> _(указывает какие тесты выполнить)_ | test                  |
> | `BROWSER_NAME`        | Опциональный                                    | Адрес сайта, где будут запускаться тесты                     | https://flat-soft.ru  |
> | `BROWSER_VERSION`     | Опциональный                                    | Браузер, в котором будут выполняться тесты                   | chrome                |
> | `BROWSER_SIZE`        | Опциональный                                    | Версия браузера, в которой будут выполняться тесты           | 125.0                 |
> | `API_URI`             | Обязательный <br> (для `всех` тестов) | Размер окна браузера, в котором будут выполняться тесты      | 1920x1080             |
> | `WEB_URL`             | Обязательный <br> (для `всех` тестов) | Адрес сайта, где будут запускаться тесты                     | https://flat-soft.ru  |
> | `TODOIST_EMAIL`       | Обязательный <br> (для `всех` тестов) | Браузер, в котором будут выполняться тесты                   | chrome                |
> | `TODOIST_PASSWORD`    | Обязательный <br> (для `всех` тестов) | Версия браузера, в которой будут выполняться тесты           | 125.0                 |
> | `TODOIST_TOKEN`       | Обязательный <br> (для `всех` тестов) | Размер окна браузера, в котором будут выполняться тесты      | 1920x1080             |
> | `WEB_REMOTE_URL`      | Обязательный <br> (для `remote-web' тестов) | Браузер, в котором будут выполняться тесты                   | chrome                |
> | `WEB_REMOTE_LOGIN`    | Обязательный <br> (для `remote-web' тестов) | Версия браузера, в которой будут выполняться тесты           | 125.0                 |
> | `WEB_REMOTE_PASSWORD` | Обязательный <br> (для `remote-web' тестов) | Размер окна браузера, в котором будут выполняться тесты      | 1920x1080             |
> | `BROWSERSTACK_URL`    | Обязательный <br> (для `remote-android' тестов) | Браузер, в котором будут выполняться тесты                   | chrome                |
> | `BROWSERSTACK_USER`   | Обязательный <br> (для `remote-android' тестов) | Версия браузера, в которой будут выполняться тесты           | 125.0                 |
> | `BROWSERSTACK_KEY`    | Обязательный <br> (для `remote-android' тестов) | Размер окна браузера, в котором будут выполняться тесты      | 1920x1080             |
>

...
>
> _<p align="justify">Тестирование проводилось на уровне программного интерфейса (API), пользовательского интерфейса web-сайта (WEB UI) и пользовательского интерфейса мобильного приложения (Android), что позволило сосредоточиться на взаимодействии пользователя с системой на различных платформах.</p>_
>

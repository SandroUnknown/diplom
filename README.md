...
> | :---              | :---             | :---                                                         | :---                                 |
> | `TASK`            | Обязательный <sup>[4](#table-of-contents)</sup> | Имя задачи в Gradle</br> _(указывает какие тесты выполнить)_ | test         |
> | `TASK`            | Обязательный <sup>([5](#table-of-contents))</sup> | Имя задачи в Gradle</br> _(указывает какие тесты выполнить)_ | test         |
> | `TASK`            | <p align="left">Обязательный <sup>[66](#table-of-contents)</sup> </p> | Имя задачи в Gradle</br> _(указывает какие тесты выполнить)_ | test         |

...
> | `API_URI`             | Обязательный для <br> `всех` тестов | Размер окна браузера, в котором будут выполняться тесты      | 1920x1080             |
> | `WEB_URL`             | Обязательный для <br> `всех` тестов | Адрес сайта, где будут запускаться тесты                     | https://flat-soft.ru  |
> | `TODOIST_EMAIL`       | Обязательный для <br> `всех` тестов | Браузер, в котором будут выполняться тесты                   | chrome                |
> | `TODOIST_PASSWORD`    | Обязательный для <br> `всех` тестов | Версия браузера, в которой будут выполняться тесты           | 125.0                 |
> | `TODOIST_TOKEN`       | Обязательный для <br> `всех` тестов | Размер окна браузера, в котором будут выполняться тесты      | 1920x1080             |
> | `WEB_REMOTE_URL`      | Обязательный для <br> `remote-web' тестов | Браузер, в котором будут выполняться тесты                   | chrome                |
> | `WEB_REMOTE_LOGIN`    | Обязательный для <br> `remote-web' тестов | Версия браузера, в которой будут выполняться тесты           | 125.0                 |
> | `WEB_REMOTE_PASSWORD` | Обязательный для <br> `remote-web' тестов | Размер окна браузера, в котором будут выполняться тесты      | 1920x1080             |
> | `BROWSERSTACK_URL`    | Обязательный для <br> `remote-android' тестов | Браузер, в котором будут выполняться тесты                   | chrome                |
> | `BROWSERSTACK_USER`   | Обязательный для <br> `remote-android' тестов | Версия браузера, в которой будут выполняться тесты           | 125.0                 |
> | `BROWSERSTACK_KEY`    | Обязательный для <br> `remote-android' тестов | Размер окна браузера, в котором будут выполняться тесты      | 1920x1080             |
>

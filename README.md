...
>
> - Проверка задач:
>    - [x] Создать новую задачу в пустом разделе </br> ` [Только для варианта отображения проекта - ДОСКА (BOARD)] `;
>    - [ ] Переместить задачу на новое место (Drag & Drop) </br> ` [Только для варианта отображения проекта - ДОСКА (BOARD)] `;</br></br>
>
> </details>

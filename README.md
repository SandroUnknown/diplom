...
> | `web`     | Запускает все `web-тесты` (при прогоне тестов также используются api-методы)     |
> | `android` | Запускает все `android-тесты` (при прогоне тестов также используются api-методы) |

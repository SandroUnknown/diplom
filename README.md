...
> | :---              | :---             | :---                                                         | :---                                 |
> | `TASK` <a name="abc"></a>            | Обязательный <sup>[1](#anchor-1)</sup> | Имя задачи в Gradle</br> _(указывает какие тесты выполнить)_ | test         |
> | `TASK`            | Обязательный <sup>[2](#anchor-2)</sup> | Имя задачи в Gradle</br> _(указывает какие тесты выполнить)_ | test         |
...
>
> <a name="anchor-1"> [1](#abc): бла бла </a><br>
> <a name="anchor-2">2: бла бла</a>

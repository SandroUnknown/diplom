...
>
> <a name="footnote-1"> [<sup>`3: При запуске на browserstack данный параметр является обязательным`</sup>](#item-1)</a><br>
> <a name="footnote-2"> [<sup>`3: При запуске на selenoid данный параметр является обязательным`</sup>](#item-2)</a><br>

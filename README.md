...
>
> <a name="footnote-1"> [`3: При запуске на browserstack данный параметр является обязательным`](#item-1)</a><br>
> <sup></sup><br>
> <a name="footnote-2"> [`3: При запуске на selenoid данный параметр является обязательным`](#item-2)</a><sub>.</sub><br>
> <a name="footnote-3"> [`3: При запуске на browserstack данный параметр является обязательным`](#item-3)</a><br>

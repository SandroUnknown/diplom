...
> | :---              | :---             | :---                                                         | :---                                 |
> | `TASK`            | Обязательный <a><p align="right">[<sup>`1`</sup>](#table-of-contents)</p></a> | Имя задачи в Gradle</br> _(указывает какие тесты выполнить)_ | test                                 |
> | `TASK`            | Обязательный <p align="right">[<sup>`2`</sup>](#table-of-contents)</p> | Имя задачи в Gradle</br> _(указывает какие тесты выполнить)_ | test                                 |
> | `TASK`            | <p align="right">[<sup>`3`</sup>](#table-of-contents)</p> Обязательный | Имя задачи в Gradle</br> _(указывает какие тесты выполнить)_ | test                                 |
> | `TASK`            | <p align="right">[<sub>`4`</sub>](#table-of-contents)</p> Обязательный | Имя задачи в Gradle</br> _(указывает какие тесты выполнить)_ | test                                 |
> | `TASK`            | <p align="right">[<sub>`[5]`</sub>](#table-of-contents)</p> Обязательный | Имя задачи в Gradle</br> _(указывает какие тесты выполнить)_ | test                                 |
> | `TASK`            | [<sub>`[6]`</sub>](#table-of-contents) Обязательный | Имя задачи в Gradle</br> _(указывает какие тесты выполнить)_ | test                                 |
> | `TASK`            | Обязательный <sup>`[7]`</sup> | Имя задачи в Gradle</br> _(указывает какие тесты выполнить)_ | test                                 |
> | `TASK`            | Обязательный <sup>[8](#table-of-contents)</sup> | Имя задачи в Gradle</br> _(указывает какие тесты выполнить)_ | test                                 |
> | `REMOTE_URL`      | Обязательный[^2] | Адрес удалённого сервера, где будут запускаться тесты        | (пустое значение ~ локальный запуск) |
> | `REMOTE_URL`      | Обязательный[^2] | Адрес удалённого сервера, где будут запускаться тесты        | (пустое значение ~ локальный запуск) |
> | `REMOTE_URL`      | Обязательный[^3] | Адрес удалённого сервера, где будут запускаться тесты        | (пустое значение ~ локальный запуск) |
...
>
> [^1]: Обязательный всегда
> [^2]: Обязательный при удалённом запуске web-теста (на selenoid)
> [^3]: Обязательный при удалённом запуске android-теста (на browserstack)
...
>
> | Параметр          | Описание                                                     | Требования                       | Значение по умолчанию |
> | :---              | :---                                                         | :---                             | :---                  |
> | `TASK`            | Имя задачи в Gradle</br> _(указывает какие тесты выполнить)_ | **Обязательный всегда**          | _`test`_                 |
> | `REMOTE_URL`      | Адрес удалённого сервера, где будут запускаться тесты        | Обязательный для `web-теста`     | Нет значения по умолчанию, требуется передача параметра пользователем               |
> | `BASE_URL`        | Адрес сайта, где будут запускаться тесты                     | Обязательный для `android-теста` | _(нет)_               |

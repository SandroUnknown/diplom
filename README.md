...
> | `TASK`            | Обязательный <p align="right">[<sup>`1`</sup>](#table-of-contents)</p> | Имя задачи в Gradle</br> _(указывает какие тесты выполнить)_ | test                                 |
> | `TASK`            | Обязательный <a>[<sup>`1`</sup>](#table-of-contents)</a> | Имя задачи в Gradle</br> _(указывает какие тесты выполнить)_ | test                                 |
> | `TASK`            | Обязательный [<sup>`1`</sup>](#table-of-contents) | Имя задачи в Gradle</br> _(указывает какие тесты выполнить)_ | test                                 |

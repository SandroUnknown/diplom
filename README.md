...
> | `API_URI`             | Обязательный для `всех` тестов | Размер окна браузера, в котором будут выполняться тесты      | 1920x1080             |
...
> | `TODOIST_TOKEN`       | Обязательный для `всех` тестов | Размер окна браузера, в котором будут выполняться тесты      | 1920x1080             |

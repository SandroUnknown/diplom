...
> 
> - Проверка разделов:
>    - [x] Создание нового раздела в пустом проекте ` [Только для варианта отображения проекта - ДОСКА (BOARD)] `;
>    - [x] Создание нового раздела в конце списка (когда в проекте уже имеется минимум 1 созданный раздел) ` [Только для варианта отображения проекта - ДОСКА (BOARD)] `;
>    - [x] Создание нового раздела между двумя ранее созданными разделами ` [Только для варианта отображения проекта - ДОСКА (BOARD)] `;
>    - [x] Удаление раздела ` [Только для варианта отображения проекта - ДОСКА (BOARD)] `;
>    - [x] Перемещение раздела на новое место (Drag & Drop) ` [Только для варианта отображения проекта - ДОСКА (BOARD)] `;</br></br>
>
> - Проверка задач:
>    - [x] Создание новой задачи;
>    - [x] Обновление задачи по ID;
